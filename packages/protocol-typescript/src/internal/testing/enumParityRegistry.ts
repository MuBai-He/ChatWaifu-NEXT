...
export const protocolModelSchemas = {
  ...
  StickerUsageRecord: stickerUsageRecordSchema,
  StickerUsageHistory: stickerUsageHistorySchema,
...
> = {
  ...
  parseStickerUsageRecord: "StickerUsageRecord",
  parseStickerUsageHistory: "StickerUsageHistory",
